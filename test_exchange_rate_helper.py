...
class TestExchangeRateHelper(unittest.TestCase):
    ...
    def test_get_all_rates(self):
        """
        Tests that the number of rates returned is equal to the number of supported currencies
        """
    ...
    def test_get_unsupported_currency_throws_exception(self):
        """
        Tests that an exception is thrown when an unsupported currency is provided
        """
    ...
    def test_rates_for_currency_returns_expected_number_of_items(self):
        """
        Tests that the number of rates returned is equal to the number of supported currencies minus 1
        """
